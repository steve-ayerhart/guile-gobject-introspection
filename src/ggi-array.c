...
static gboolean
_ggi_marshal_garray_from_scm_list (GGIInvokeState *state,
...
static void
_ggi_marshal_cleanup_from_scm_list (GGIInvokeState *state,
                                    GGIArgCache    *arg_cache,
                                    SCM             scm_arg,
                                    gpointer        data,
...
static SCM
_ggi_marshal_garray_to_scm_list (GGIInvokeState  *state,
                                 GGICallableCache *callable_cache,
                                 GGIArgCache      *arg_cache,
                                 GIArgument       *arg,
                                 gpointer         *cleanup_data)
...
static GArray *
_wrap_c_array (GGIInvokeState *state,
               GGIArgGArray   *array_cache,
               gpointer        data)
{
    GArray *array_;
...
static void
_ggi_marshal_garray_cleanup_to_scm_list (GGIInvokeState *state,
                                         GGIArgCache     *arg_cache,
                                         gpointer        cleanup_data,
                                         gpointer        data,
                                         gboolean        was_processed)
...
static void
_array_cache_free_func (GGIArgGArray *cache)
{
    if (cache != NULL)
        {
...
{
    GGIArgGArray *list_cache = (GGIArgGArray *) arg_cache;

    return NULL;
}

static gboolean
ggi_arg_garray_setup (GGIArgGArray *sc,
                      GITypeInfo   *type_info,
                      GIArgInfo    *arg_info,
                      GITransfer    transfer,
                      GGIDirection  direction,
                              ...
                              GGICallableCache *callable_cache)
{
    ...
    if (!ggi_arg_garray_setup (array_cache,
                               type_info,
                               arg_info,
                               transfer,
                               direction,
