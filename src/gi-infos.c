...
#include "ggi-info.x"
  ...
  scm_callable_info_type = scm_permanent_object (SCM_VARIABLE_REF (scm_c_lookup ("<gi-callable-info>")));
  scm_function_info_type = scm_permanent_object (SCM_VARIABLE_REF (scm_c_lookup ("<gi-function-info>")));
  scm_signal_info_type = scm_permanent_object (SCM_VARIABLE_REF (scm_c_lookup ("<gi-signal-info>")));
  scm_v_func_info_type = scm_permanent_object (SCM_VARIABLE_REF (scm_c_lookup ("<gi-v-func-info>")));
  scm_callback_info_type = scm_permanent_object (SCM_VARIABLE_REF (scm_c_lookup ("<gi-callback-info>")));
  scm_registered_type_info_type =
    scm_permanent_object (SCM_VARIABLE_REF (scm_c_lookup ("<gi-registered-type-info>")));
  scm_enum_info_type = scm_permanent_object (SCM_VARIABLE_REF (scm_c_lookup ("<gi-enum-info>")));
  scm_interface_info_type = scm_permanent_object (SCM_VARIABLE_REF (scm_c_lookup ("<gi-interface-info>")));
  scm_object_info_type = scm_permanent_object (SCM_VARIABLE_REF (scm_c_lookup ("<gi-object-info>")));
  scm_struct_info_type = scm_permanent_object (SCM_VARIABLE_REF (scm_c_lookup ("<gi-struct-info>")));
  scm_union_info_type = scm_permanent_object (SCM_VARIABLE_REF (scm_c_lookup ("<gi-union-info>")));
  scm_arg_info_type = scm_permanent_object (SCM_VARIABLE_REF (scm_c_lookup ("<gi-arg-info>")));
  scm_constant_info_type = scm_permanent_object (SCM_VARIABLE_REF (scm_c_lookup ("<gi-constant-info>")));
  scm_field_info_type = scm_permanent_object (SCM_VARIABLE_REF (scm_c_lookup ("<gi-field-info>")));
  scm_property_info_type = scm_permanent_object (SCM_VARIABLE_REF (scm_c_lookup ("<gi-property-info>")));
  scm_value_info_type = scm_permanent_object (SCM_VARIABLE_REF (scm_c_lookup ("<gi-value-info>")));
  scm_type_info_type = scm_permanent_object (SCM_VARIABLE_REF (scm_c_lookup ("<gi-type-info>")));
}
